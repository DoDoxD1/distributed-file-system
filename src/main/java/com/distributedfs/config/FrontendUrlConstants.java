...
public final class FrontendUrlConstants {
    ...
    public static final String TEST_FRONTEND_ORIGIN_PATTERN = "http://127.0.0.1:*";
    public static final String DUCKDNS_FRONTEND_ORIGIN = "https://dfs-ui.duckdns.org";
    public static final List<String> DEFAULT_CORS_ALLOWED_ORIGIN_PATTERNS = List.of(
        LOCALHOST_FRONTEND_ORIGIN_PATTERN,
        TEST_FRONTEND_ORIGIN_PATTERN,
